...
./autogen.sh 
./configure --with-linux=/usr/lib64/modules/$(ls /lib64/modules)/source --with-linux-obj=/usr/lib64/modules/$(ls /lib64/modules)/build --with-spl=/root/spl-spl-$ZOL_VERSION/
automake
make -j$(nproc)
make install
